...
if(NOT TARGET libbot2::lcmtypes_bot2-procman-java)
  ...
  set_target_properties(libbot2::lcmtypes_bot2-procman-java PROPERTIES
    IMPORTED_LOCATION ${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/share/java/lcmtypes_bot2-procman.jar
    JAR_FILE ${${CMAKE_FIND_PACKAGE_NAME}_IMPORT_PREFIX}/share/java/lcmtypes_bot2-procman.jar
  )
endif()
